...
const FooterEnhanced = () => {
  ...
  const services = [
    { name: 'Collision Repair', href: '/services/collision-repair', icon: '🔧' },
    { name: 'Paint Jobs', href: '/services/paint-jobs', icon: '🎨' },
    { name: 'Wheel Replacement', href: '/services/wheel-replacement', icon: '⚙️' },
  ...
  const quickLinks = [
    ...
    { name: 'Certified Ceramic', href: '/services/certified-ceramic', icon: '✨' },
    { name: 'A/C Servicing', href: '/services/ac-servicing', icon: '❄️' },
    { name: 'Photo Estimates', href: '/services/photo-estimates', icon: '📸' },
    { name: 'Wheel Alignments', href: '/services/wheel-alignments', icon: '🎯' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-neutral-400 text-sm mb-6 leading-relaxed">
              FITTA is the premier auto body repair shop in Africa, serving Ghana and Hudson Valley, Poughkeepsie, NY.
            </p>
            <div className="space-y-2 text-sm">
              <p className="font-semibold">Talk To Our Experts</p>
              <a href="tel:+233544543220" className="text-primary-400 hover:text-primary-300 transition-colors text-lg font-bold">
                (+233) 544-543-220
              </a>
            </div>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-lg font-bold mb-6 text-primary-400">FITTA's Services</h4>
          ...
          {/* Site Map */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-primary-400">Site Map</h4>
            <div className="space-y-3">
              {siteMap.map((item) => (
                <Link
                  key={item.name}
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <p className="text-xs text-neutral-500 mb-1">For Repair Support</p>
                <a href="tel:+233544543220" className="text-neutral-300 hover:text-white transition-colors font-semibold">
                  (+233) 544-543-220
                </a>
              </div>
              <div>
                <p className="text-xs text-neutral-500 mb-1">The Working Hours</p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-neutral-500 text-center md:text-left">
              Copyright © 2025 FITTA's Auto Body & Collision Repair Services. All Rights Reserved.
            </p>
