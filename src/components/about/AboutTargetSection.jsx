          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg text-secondary-600 dark:text-neutral-300 leading-relaxed">
                Our aim is to become West Africa's leading vehicle service platform, 
                empowering vehicle owners to access help instantly, providing mechanics with 
                steady income opportunities, and giving businesses powerful tools to manage 
                their fleets efficiently.
              </p>

              <p className="text-lg text-secondary-600 dark:text-neutral-300 leading-relaxed">
                We're building more than just an app - we're creating an ecosystem that transforms 
                how vehicle services are delivered. From emergency roadside assistance to routine 
                maintenance, insurance claims to fleet management, FITTA is your trusted partner 
                on every journey.
              </p>
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-6 h-6 rounded-full bg-primary-500 flex-shrink-0 mt-0.5" />
                  <p className="text-lg text-secondary-700 dark:text-neutral-300">
                    Empower 5,000+ mechanics with sustainable income opportunities
                  </p>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-6 h-6 rounded-full bg-primary-500 flex-shrink-0 mt-0.5" />
