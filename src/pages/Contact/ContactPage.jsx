  ...
  const contactMethods = [
    {
      ...
      value: '+233 544 543 220',
      action: 'tel:+233544543220',
      buttonText: 'Call Now',
      color: 'primary',
    ...
    },
    {
      ...
      value: '+233 544 543 220',
      action: 'https://wa.me/233544543220',
    ...
    },
    {
      ...
      value: 'support@fitta.com',
      action: 'mailto:support@fitta.com',
    ...
    },
    {
      ...
      value: 'Accra Digital Centre, Ring Road Central',
      action: '#',
  ...
  const faqs = [
    {
      ...
      answer: 'Our emergency response team typically arrives within 15-30 minutes in urban areas and 30-60 minutes in suburban areas, depending on traffic and location.'
    },
    {
      question: 'What areas do you cover in Ghana?',
      answer: 'We currently provide services in Accra, Kumasi, Takoradi, Cape Coast, Tamale, and surrounding areas. We are continuously expanding our coverage.'
    },
    {
      question: 'How do I become a garage partner?',
      answer: 'Visit our garage partner registration page, complete the application form, and our team will guide you through the verification and onboarding process.'
    },
    {
      question: 'Are your service providers certified?',
      answer: 'Yes, all our service providers undergo thorough background checks, certification verification, and continuous training to ensure quality service delivery.'
    },
    {
      question: 'What payment methods do you accept?',
      answer: 'We accept mobile money (MTN, Vodafone, AirtelTigo), bank transfers, credit/debit cards, and cash payments depending on the service type.'
    },
    {
      question: 'Can I track my service provider in real-time?',
      answer: 'Yes, once a service provider is assigned to your request, you can track their location and estimated arrival time through our platform.'
    }
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-secondary-900">
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className={`text-4xl md:text-6xl font-black text-white mb-6 transition-all duration-1000 ${
                ...
                Get In Touch With
                <span className="block text-secondary-400 mt-2">Our Expert Team</span>
              </h1>
              
              <p className={`text-xl text-white/90 mb-8 transition-all duration-1000 delay-200 ${
                heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}>
                We're here to help 24/7. Reach out for emergency assistance, partnerships, 
                or any questions about our automotive services.
              </p>
              ...
              <div className={`flex flex-wrap gap-4 justify-center transition-all duration-1000 delay-400 ${
                ...
                <Button
                  variant="glass"
                  size="lg"
                  onClick={() => window.open('https://wa.me/233544543220', '_blank')}
                  className="min-w-[200px]"
                >
                  WhatsApp Chat
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section ref={contactRef} className="py-20 bg-white dark:bg-secondary-900">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className={`text-4xl md:text-5xl font-black text-secondary-900 dark:text-white mb-4 transition-all duration-1000 ${
                contactVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}>
                Multiple Ways To
                <span className="block text-primary-500 mt-2">Reach Us</span>
              </h2>
              <p className={`text-lg text-secondary-600 dark:text-neutral-300 max-w-3xl mx-auto transition-all duration-1000 delay-200 ${
                contactVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}>
                Choose the most convenient way to contact us. We're available 24/7 for emergencies 
                and during business hours for general inquiries.
              </p>
            </div>
                  ...
                  <Card className="h-full hover:shadow-xl transition-all duration-300 group cursor-pointer"
                    ...
                    <div className={`p-8 bg-gradient-to-br ${
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="text-lg font-semibold mb-2">{method.value}</div>
                        <div className="text-sm text-white/80">{method.available}</div>
                      </div>
                    </div>
        ...
        <section ref={formRef} className="py-20 bg-gradient-to-br from-neutral-50 to-white dark:from-secondary-800 dark:to-secondary-900">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-white dark:bg-secondary-800 rounded-xl p-6 shadow-lg">
                    ...
                    <div className="space-y-3 text-secondary-600 dark:text-neutral-300">
                      <p><strong>Address:</strong><br />Accra Digital Centre<br />Ring Road Central, Accra</p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className={`text-lg text-secondary-600 dark:text-neutral-300 max-w-3xl mx-auto transition-all duration-1000 delay-200 ${
                ...
                Find quick answers to common questions about our services, coverage, and processes.
              </p>
            </div>
