...
const OurWorkPage = () => {
  ...
  const portfolio = [
    ...
    },
    {
      ...
      beforeImage:
        "https://images.unsplash.com/photo-1518987048-93e29699e79a?w=800",
      afterImage:
    ...
    },
    {
      ...
      beforeImage:
        "https://images.unsplash.com/photo-1606611013016-969c19af27df?w=800",
      afterImage:
        "https://images.unsplash.com/photo-1617654697012-22b7039ac10d?w=800",
      duration: "7 days",
      rating: 4.8,
    ...
    <Layout>
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p
            className={`text-xl text-neutral-300 mb-8 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${
              heroVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
          >
            Explore our portfolio of transformations. From minor repairs to
            complete restorations, we deliver excellence in every project.
          </p>
      ...
      <section
        ref={galleryRef}
        className="py-20 bg-neutral-50 dark:bg-secondary-800"
      >
      ...
      <section
        ref={statsRef}
        className="py-20 bg-gradient-to-r from-primary-600 to-primary-500 text-white"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p
              className={`text-xl opacity-90 transition-all duration-1000 delay-200 ${
                statsVisible
                  ? "opacity-100 translate-y-0"
                  : "opacity-0 translate-y-10"
              }`}
      ...
      <section className="py-20 bg-white dark:bg-secondary-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-secondary-600 dark:text-neutral-300 mb-8">
            Join thousands of satisfied customers who trust FITTA for their
            vehicle needs
          </p>
              ...
              <div className="p-8">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                  <div className="text-center p-4 bg-neutral-100 dark:bg-secondary-800 rounded-lg">
                    ...
                    <div className="text-secondary-600 dark:text-neutral-300">
